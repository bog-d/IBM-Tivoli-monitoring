...
if (empty($mode) or (strcmp($mode, OPER) != 0 and strcmp($mode, HIST) != 0)) {
    exit("<ul>
        <li><h3><a href='blackout_2.php?mode=oper'>Оперативный график</a></h3></li>&emsp;&emsp;&emsp;
        выводится информация о технологических работах за 12 ч до настоящего времени и 12 ч после<br><br><br>
        <li><h3><a href='blackout_2.php?mode=hist'>Исторические графики</a></h3>&emsp;&emsp;&emsp;
